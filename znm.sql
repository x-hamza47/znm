...
(1, 'noman', '$2y$14$VWHm299VCGCo8eogPvHfSuijKdo7nzchMnsF1okHKoovohg3A69Ga');
...
CREATE TABLE `sub_categories` (
  ...
  PRIMARY KEY(id),
  FOREIGN KEY (`category_id`) REFERENCES `categories`(`cid`) ON DELETE CASCADE ON UPDATE CASCADE
) 
